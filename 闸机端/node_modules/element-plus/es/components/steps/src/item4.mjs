import { defineComponent, ref, inject, getCurrentInstance, onMounted, watch, onBeforeUnmount, computed, reactive, openBlock, createElementBlock, normalizeStyle, unref, normalizeClass, createCommentVNode, createElementVNode, renderSlot, createBlock, withCtx, resolveDynamicComponent, toDisplayString, createTextVNode } from 'vue';
import '../../../hooks/index2.mjs';
import { ElIcon } from '../../icon/index2.mjs';
import { Check, Close } from '@element-plus/icons-vue';
import { stepProps } from './item3.mjs';
        ...
        createElementVNode("div", {
          ...
          createElementVNode("div", {
            ...
            unref(currentStatus) !== "success" && unref(currentStatus) !== "error" ? renderSlot(_ctx.$slots, "icon", { key: 0 }, () => [
              ...
              default: withCtx(() => [
                unref(currentStatus) === "success" ? (openBlock(), createBlock(unref(Check), { key: 0 })) : (openBlock(), createBlock(unref(Close), { key: 1 }))
              ]),
              _: 1
            }, 8, ["class"]))
          ], 2)
...
//# sourceMappingURL=item4.mjs.map

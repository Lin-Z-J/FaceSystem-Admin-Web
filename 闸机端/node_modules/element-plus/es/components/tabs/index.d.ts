export declare const ElTabs: import("element-plus/es/utils").SFCWithInstall<import("vue").DefineComponent<{
    ...
    readonly activeName: import("element-plus/es/utils").EpPropFinalized<readonly [StringConstructor, NumberConstructor], unknown, unknown, "", boolean>;
    ...
    readonly beforeLeave: import("element-plus/es/utils").EpPropFinalized<(new (...args: any[]) => (newName: import("./src/tabs").TabPanelName, oldName: import("./src/tabs").TabPanelName) => import("element-plus/es/utils").Awaitable<boolean | void>) | (() => (newName: import("./src/tabs").TabPanelName, oldName: import("./src/tabs").TabPanelName) => import("element-plus/es/utils").Awaitable<boolean | void>) | {
        (): (newName: import("./src/tabs").TabPanelName, oldName: import("./src/tabs").TabPanelName) => import("element-plus/es/utils").Awaitable<boolean | void>;
        new (): any;
        readonly prototype: any;
    } | ((new (...args: any[]) => (newName: import("./src/tabs").TabPanelName, oldName: import("./src/tabs").TabPanelName) => import("element-plus/es/utils").Awaitable<boolean | void>) | (() => (newName: import("./src/tabs").TabPanelName, oldName: import("./src/tabs").TabPanelName) => import("element-plus/es/utils").Awaitable<boolean | void>) | {
        (): (newName: import("./src/tabs").TabPanelName, oldName: import("./src/tabs").TabPanelName) => import("element-plus/es/utils").Awaitable<boolean | void>;
        new (): any;
        readonly prototype: any;
    ...
    readonly closable: boolean;
    readonly activeName: import("element-plus/es/utils").EpPropMergeType<readonly [StringConstructor, NumberConstructor], unknown, unknown>;
    readonly tabPosition: import("element-plus/es/utils").EpPropMergeType<StringConstructor, "left" | "right" | "top" | "bottom", unknown>;
    readonly beforeLeave: (newName: import("./src/tabs").TabPanelName, oldName: import("./src/tabs").TabPanelName) => import("element-plus/es/utils").Awaitable<boolean | void>;
    ...
    TabPane: import("vue").DefineComponent<{
        ...
        readonly name: import("element-plus/es/utils").EpPropFinalized<readonly [StringConstructor, NumberConstructor], unknown, unknown, "", boolean>;
        readonly closable: BooleanConstructor;

...
var imageViewer = require('./image-viewer3.js');
...
var index$2 = require('../../../hooks/use-z-index/index2.js');
...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    const currentImg = vue.computed(() => {
      return props.urlList[index$4.value];
    });
    ...
    function prev() {
      ...
      index$4.value = (index$4.value - 1 + len) % len;
    }
    function next() {
      if (isLast.value && !props.infinite)
        return;
      const len = props.urlList.length;
      index$4.value = (index$4.value + 1) % len;
    }

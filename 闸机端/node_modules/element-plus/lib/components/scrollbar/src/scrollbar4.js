...
var bar = require('./bar4.js');
var scrollbar = require('./scrollbar3.js');
...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { expose, emit }) {
    ...
    const update = () => {
      if (!wrap$.value)
        return;
      const offsetHeight = wrap$.value.offsetHeight - util.GAP;
      const offsetWidth = wrap$.value.offsetWidth - util.GAP;
      ...
      return vue.openBlock(), vue.createElementBlock("div", {
        ...
        vue.createElementVNode("div", {
          ...
          class: vue.normalizeClass([
            _ctx.wrapClass,
            vue.unref(ns).e("wrap"),
            { [vue.unref(ns).em("wrap", "hidden-default")]: !_ctx.native }
          ]),
          ...
          (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(_ctx.tag), {
            ref_key: "resize$",
            ref: resize$,
            class: vue.normalizeClass([vue.unref(ns).e("view"), _ctx.viewClass]),
...
//# sourceMappingURL=scrollbar4.js.map

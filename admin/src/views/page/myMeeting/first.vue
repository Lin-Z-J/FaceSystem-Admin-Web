<template>
  <div class="table-box">
    ...
    <div class="table-search">
      ...
      <el-form :inline="true" :model="searchQueryMeetingForm" class="demo-form-inline">
        <!--        <el-form-item label="主持人">
          <el-input v-model="searchQueryMeetingForm.host" placeholder="主持人"></el-input>
        </el-form-item> -->
        <el-form-item label="会议主题">
          <el-input v-model="searchQueryMeetingForm.meetingname" placeholder="会议主题" clearable></el-input>
        </el-form-item>
        <!--        <el-form-item label="会议室">
          <el-select v-model="MeetingRoom.roomName" placeholder="请选择会议室" clearable>
            <el-option
    ...
    >
      ...
      <el-table-column label="会议主题" width="200" show-overflow-tooltip>
        <template #default="scope">
          <div style="display: flex; align-items: center">
            ...
            <el-tooltip
              :content="'主持人:' + this.meetingHost"
              placement="top"
              effect="light"
              @show="onPopoverShow(scope.row.id)"
            >
              <el-link type="primary">{{ scope.row.name }}</el-link>
            </el-tooltip>
          </div>
      ...
      <el-table-column label="会议介绍" width="">
        <template #default="scope">
          <div style="display: flex; align-items: center">
      ...
      <el-table-column label="签到状态" width="100">
        <template #default="scope">
          <div style="display: flex; align-items: center">
            <span style="margin-left: 10px">{{ scope.row.state === 0 ? '未签到' : '已签到' }}</span>

            <!-- <span style="margin-left: 10px">未签到</span> -->
          </div>
        </template>
      </el-table-column>
      ...
      <el-row :gutter="10">
        <el-col :span="12">
          ...
          <el-card class="box-card" style="box-shadow: none; height: 510px">
            ...
            <el-form ref="form" :model="updateMeetingdata" label-width="80px">
              <el-row>
                <el-col :span="12">
                  <el-form-item label="会议室">
    ...
    methods: {
      ...
      onPopoverShow(id) {
        searchHost(id).then((response) => {
          // console.log('查询我的会议主持人', response);
          this.meetingHost = response.data;
        });
      },
      onPopoverHide() {
        this.meetingHost = '';
      ...
      OnSearchSubmit() {
        ...
        this.searchQueryMeetingForm.userid = this.user.id;
        ...
        //   console.log('查询我的会议', response);
        //   this.meetingList = response.data;
        //   this.pageable.total = this.meetingList.length;
        // });

        searchUserMeetingByWant(this.searchQueryMeetingForm).then((response) => {
          // console.log('模糊查询我的会议', response);
          this.meetingList = response.data;
          this.pageable.total = this.meetingList.length;
        });
      },

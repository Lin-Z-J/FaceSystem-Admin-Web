...
import { paginationPagerProps } from './pager3.mjs';
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("ul", {
        ...
        showPrevMore.value ? (openBlock(), createElementBlock("li", {
          ...
          quickPrevHover.value || quickPrevFocus.value ? (openBlock(), createBlock(unref(DArrowLeft), { key: 0 })) : (openBlock(), createBlock(unref(MoreFilled), { key: 1 }))
        ...
        showNextMore.value ? (openBlock(), createElementBlock("li", {
          ...
          quickNextHover.value || quickNextFocus.value ? (openBlock(), createBlock(unref(DArrowRight), { key: 0 })) : (openBlock(), createBlock(unref(MoreFilled), { key: 1 }))
...
//# sourceMappingURL=pager4.mjs.map

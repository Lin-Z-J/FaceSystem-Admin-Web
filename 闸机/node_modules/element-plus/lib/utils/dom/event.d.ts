...
export declare const on: (element: HTMLElement | Document | Window | Element, event: string, handler: EventListenerOrEventListenerObject, useCapture?: boolean) => void;
/** @deprecated use `element.addEventListener` instead */
export declare const off: (element: HTMLElement | Document | Window | Element, event: string, handler: EventListenerOrEventListenerObject, useCapture?: boolean) => void;
/** @deprecated use `element.addEventListener` instead */

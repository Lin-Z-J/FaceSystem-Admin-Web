...
function createTablePopper(parentNode, trigger, popperContent, popperOptions, tooltipEffect) {
  ...
  exports.removePopper = () => {
    try {
      ...
      event.off(trigger, "mouseleave", exports.removePopper);
      if (scrollContainer) {
        event.off(scrollContainer, "scroll", exports.removePopper);
      }
      exports.removePopper = void 0;
    } catch (e) {
    }
  ...
  if (scrollContainer) {
    event.on(scrollContainer, "scroll", exports.removePopper);
  }

...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    const { focus, isChecked, isDisabled, size, model, handleChange } = checkbox.useCheckbox(props, slots);
    const { checkboxGroup } = checkbox.useCheckboxGroup();
...
//# sourceMappingURL=checkbox-button2.js.map

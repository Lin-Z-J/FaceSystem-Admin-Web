...
var basicTimeSpinner = require('../props/basic-time-spinner2.js');
var useTimePicker = require('../composables/use-time-picker2.js');
var pluginVue_exportHelper = require('../../../../_virtual/plugin-vue_export-helper.js');
var index = require('../../../../hooks/use-namespace/index2.js');
var index$3 = require('../../../../directives/repeat-click/index2.js');
...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    const scrollDown = (step) => {
      ...
      let now = vue.unref(timePartials)[label];
        ...
        _ctx.arrowControl ? (vue.openBlock(true), vue.createElementBlock(vue.Fragment, { key: 1 }, vue.renderList(vue.unref(spinnerItems), (item) => {
          return vue.openBlock(), vue.createElementBlock("div", {
            ...
            vue.withDirectives((vue.openBlock(), vue.createBlock(vue.unref(index$2.ElIcon), {
              ...
              [vue.unref(index$3["default"]), onDecrement]
            ]),
            vue.withDirectives((vue.openBlock(), vue.createBlock(vue.unref(index$2.ElIcon), {
              ...
              [vue.unref(index$3["default"]), onIncrement]
            ]),

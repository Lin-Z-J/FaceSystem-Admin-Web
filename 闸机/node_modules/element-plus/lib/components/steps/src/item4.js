    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        ...
        vue.createElementVNode("div", {
          ...
          vue.createElementVNode("div", {
            class: vue.normalizeClass([vue.unref(ns).e("icon"), vue.unref(ns).is(_ctx.icon ? "icon" : "text")])
          }, [
            vue.unref(currentStatus) !== "success" && vue.unref(currentStatus) !== "error" ? vue.renderSlot(_ctx.$slots, "icon", { key: 0 }, () => [
              ...
              default: vue.withCtx(() => [
                vue.unref(currentStatus) === "success" ? (vue.openBlock(), vue.createBlock(vue.unref(iconsVue.Check), { key: 0 })) : (vue.openBlock(), vue.createBlock(vue.unref(iconsVue.Close), { key: 1 }))
              ]),
              _: 1
            }, 8, ["class"]))
          ], 2)
